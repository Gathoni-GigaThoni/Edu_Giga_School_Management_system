...
def upgrade() -> None:
    ...
    # ── academic_level ────────────────────────────────────────────────────────
    if not insp.has_table("academic_level"):
        op.create_table(
            "academic_level",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("name", sa.String(), nullable=False),
    ...
    # ── academic_year ─────────────────────────────────────────────────────────
    if not insp.has_table("academic_year"):
        op.create_table(
            "academic_year",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("name", sa.String(), nullable=False),
    ...
    # ── school_class ──────────────────────────────────────────────────────────
    if not insp.has_table("school_class"):
        op.create_table(
            "school_class",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    if not insp.has_table("parent_guardian"):
        op.create_table(
            "parent_guardian",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    if not insp.has_table("medical_history"):
        op.create_table(
            "medical_history",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── student_supply ────────────────────────────────────────────────────────
    if not insp.has_table("student_supply"):
        op.create_table(
            "student_supply",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── skill_assessment ──────────────────────────────────────────────────────
    if not insp.has_table("skill_assessment"):
        op.create_table(
            "skill_assessment",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    if not insp.has_table("termly_report_comment"):
        op.create_table(
            "termly_report_comment",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── disciplinary_log ──────────────────────────────────────────────────────
    if not insp.has_table("disciplinary_log"):
        op.create_table(
            "disciplinary_log",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── previous_education ────────────────────────────────────────────────────
    if not insp.has_table("previous_education"):
        op.create_table(
            "previous_education",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── medical_information ───────────────────────────────────────────────────
    if not insp.has_table("medical_information"):
        op.create_table(
            "medical_information",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── parent_info ───────────────────────────────────────────────────────────
    if not insp.has_table("parent_info"):
        op.create_table(
            "parent_info",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── student_club ──────────────────────────────────────────────────────────
    if not insp.has_table("student_club"):
        op.create_table(
            "student_club",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
    ...
    # ── student_route ─────────────────────────────────────────────────────────
    if not insp.has_table("student_route"):
        op.create_table(
            "student_route",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("student_id", sa.Integer(), nullable=False),
